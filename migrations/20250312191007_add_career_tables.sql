...
('detective', 'Detective', 'get_to_work', ''),
...
('gardener', 'Gardener', 'seasons', ''),
('actor', 'Actor', 'get_famous', ''),
...
('engineer', 'Engineer', 'discover_university', ''),
('law', 'Law', 'discover_university', ''),
...
('interior_decorator', 'Interior Decorator', 'dream_home_decorator', ''),
...
('detective', 'detective', 'Detective', 'get_to_work', ''),
...
('interior_decorator', 'interior_decorator', 'Interior Decorator', 'dream_home_decorator', ''),
