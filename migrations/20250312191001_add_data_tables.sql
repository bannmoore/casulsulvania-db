...
('jealous', 'Jealous', 'base', ARRAY['child', 'teen', 'young_adult', 'adult', 'elder']::age_id[], 'These Sims get Jealous more easily than other Sims. They gain a boost of Confidence from being around their significant other, but get Tense if they haven''t seen them recently.'),
...
('noncommital', 'Noncommital', 'base', ARRAY['young_adult', 'adult', 'elder']::age_id[], 'These Sims become Tense after a while in the same job or relationship, become Happy when they Quit a Job or Break Off a relationship, take longer to Propose, and can Discuss their Fear of Commitment.'),
...
DROP TYPE IF EXISTS aspiration_category;
